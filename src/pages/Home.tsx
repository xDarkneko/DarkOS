    ...
    <div className="pt-32 pb-24 px-6 max-w-7xl mx-auto min-h-screen flex flex-col items-center">
      ...
      <div className="w-full mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
          <StatsCard delay={0.1} metricKey="users" title={t('totalUsers')} value="—" icon={Users} />
          <StatsCard delay={0.2} metricKey="status" title={t('botStatus')} value="—" icon={Zap} />
          <StatsCard delay={0.3} metricKey="commands" title={t('commandsRun')} value="—" icon={Code2} />
          <StatsCard delay={0.4} metricKey="tickets" title={t('openTickets')} value="—" icon={Ticket} />
          <StatsCard delay={0.5} metricKey="messages" title={t('messagesProcessed')} value="—" icon={MessageSquare} />
          <StatsCard delay={0.6} metricKey="joins" title={t('joinLeaveStats')} value="—" icon={UserPlus} />
        </div>
        <p className="text-xs text-gray-400 dark:text-gray-600 mt-4 text-center italic">
          {t('syncNote')}
        </p>
      </div>
