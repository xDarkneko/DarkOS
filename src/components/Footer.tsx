...
// Uses HashRouter — links work with static file serving
import { useStore } from '../store/useStore';

const logoDark = `${import.meta.env.BASE_URL}images/logo.png`;
const logoLight = `${import.meta.env.BASE_URL}images/logo_white.png`;
